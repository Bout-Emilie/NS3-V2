...
NS_LOG_COMPONENT_DEFINE ("Radio channel selection");
...
NS_LOG_UNCOND("--channNum: " << channNum);
...
CommandLine cmd;
 ...
 // Mobility model   
    ...
    mobility.SetPositionAllocator ("ns3::GridPositionAllocator",
                                 ...
                                 "GridWidth", UintegerValue (numberNode),  // will create linear topology
